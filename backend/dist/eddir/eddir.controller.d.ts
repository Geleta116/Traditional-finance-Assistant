...
export declare class EddirController {
    ...
    createEdir(data: EdirDTO, req: Request): Promise<import("../typeorm/edir entities/edir.entity").Edir[]>;
    joinEdir(dto: JoinEdirDTO, req: Request): Promise<import("../typeorm/edir entities/edir_members.entity").Edirmembers>;
    ...
    getMembers(id: number): Promise<import("../typeorm/edir entities/edir_members.entity").Edirmembers[]>;
    getNotification(req: Request): Promise<import("../typeorm/edir entities/edir_notification.entity").EdirNotifications[]>;
    ...
    sendMessage(id: number, edirChatDTO: EdirChatDTO, req: Request): Promise<import("../typeorm/edir entities/edir_chatroom.entity").Edirchatroom>;
    getMessage(id: number): Promise<import("../typeorm/edir entities/edir_chatroom.entity").Edirchatroom[]>;
}
